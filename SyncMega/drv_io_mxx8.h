...
#define VTIM_EN_INTR		TIMSK1 = (1<<TOIE1)|(0<<OCIE1A)|(0<<OCIE1B)|(0<<ICIE1)		// Enable interrupt
#define VTIM_DIS_INTR		TIMSK1 = (0<<TOIE1)|(0<<OCIE1A)|(0<<OCIE1B)|(0<<ICIE1)		// Disable interrupt
...
#define LACT_STOP			TCCR0B &= ~(1<<CS01)							// Stop timer
