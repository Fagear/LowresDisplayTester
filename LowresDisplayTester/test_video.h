...
enum
{
	H_STBL_DELAY			= 53,	// Delay to stabilize active region timing
	A_MONO_STBL_DELAY		= 231,	// Delay to stabilize bar drawing (for monochrome output)
	...
	COMP_ACT_DELAY_525i		= 158,	// (Tsync) Delay from H-sync to active part of the line for composite 525icomposite 525i
	...
	VGA_ACT_DELAY			= 100,	// (Tsync) Delay from H-sync to active part of the line for VGA 640x480
};
...
enum
{
	...
	ST_COMP625_F1_VS_PLS1	= 0,	// 625i, field 1, start of vertical sync pulse (not for composite sync)
	ST_COMP625_F1_VS_STOP	= 4,	// 625i, field 1, end of vertical sync, start of post-EQ pulses
	ST_COMP625_F1_VS_PLS2	= 5,	// 625i, field 1, end of vertical sync pulse (not for composite sync)
	...
	ST_COMP625_F2_VS_PLS1	= 320,	// 625i, field 2, start of vertical sync pulse (not for composite sync)
	ST_COMP625_F2_VS_STOP	= 324,	// 625i, field 2, end of vertical sync, start of post-EQ pulses
	ST_COMP625_F2_VS_PLS2	= 325,	// 625i, field 2, end of vertical sync pulse (not for composite sync)
...
enum
{
	...
	ST_COMP525_F1_VS_PLS1	= 6,	// 525i, field 1, start of vertical sync pulse (not for composite sync)
	ST_COMP525_F1_VS_STOP	= 11,	// 525i, field 1, end of vertical sync, start of post-EQ pulses
	ST_COMP525_F1_VS_PLS2	= 12,	// 525i, field 1, end of vertical sync pulse (not for composite sync)
	...
	ST_COMP525_F2_VS_PLS1	= 278,	// 525i, field 2, start of vertical sync pulse (not for composite sync)
	ST_COMP525_F2_VS_STOP	= 283,	// 525i, field 2, end of vertical sync, start of post-EQ pulses
	ST_COMP525_F2_VS_PLS2	= 284,	// 525i, field 2, end of vertical sync pulse (not for composite sync)
...
enum
{
	...
	EGA_VS_START			= 261,	// EGA, start of vertical sync
};
